...
public class Demo {
  public static void main(String[] args) throws IOException {
    ...
    System.out.println(new Exporter().toDataSection(Collections.singleton(first.getValue())));
    System.out.println(new Exporter().toDataSection(Collections.singleton(iterator.next().getValue())));
    System.out.println(new Exporter().toDataSection(Collections.singleton(iterator.next().getValue())));
    System.out.println(new Exporter().toDataSection(Collections.singleton(iterator.next().getValue())));
    System.out.println(new Exporter().toDataSection(Collections.singleton(iterator.next().getValue())));
    System.out.println(new Exporter().toDataSection(Collections.singleton(iterator.next().getValue())));
